...
LotteryContract.prototype = {
  ...
  bets: function (itemBets, odds) {
    ...
    var totalVal = BigNumber(0);
    // 计算总的需要金额
    for( itemBet in itemBets ) {
...
setItemDone: function (itemId) {
  ...
  settlement: function () {
    ...
    mywagers.forEach(function (wager, key, map) {
